...
class SnakeGame {
    ...
    public int move(String direction) {
        ...
        Pair<Integer, Integer> newHead = new Pair(currentHead.getKey()+dir.getKey(), currentHead.getValue()+dir.getValue());
        ...
        if(newHead.equals(food)){
            ...
            if((snakeLocation.contains(newHead)) ||
                    newHead.getKey() < 0 || newHead.getKey() >= row || newHead.getValue() < 0 || newHead.getValue() >= col){
                return -1;
            }
